          ...
          <tbody>
            {filteredResidents.map(resident => (
              <tr key={resident.userId}>
                ...
                <td className="border px-4 py-2">{resident.isVerified ? 'Yes' : 'No'}
